            ...
            <b-collapse id="instrCollapse">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <span class="d-block"
                    ><b>Note:</b> The "version" column is only required if using
                    test versions (see below)</span
                  >
                  <span class="d-block"
                    ><b>Note 2:</b> Blank answers are OK ("see opt6,
                    below")</span
                  >
                  <span class="d-block mb-2"
                    ><b>Note 3:</b> The "ans" column is the number of the
                    correct "opt"</span
                  >
                  <img
                    src="@/assets/img/template-example-2.jpg"
                    class="img-fluid"
                  />
                  ...
                  <ol>
                    ...
                    <li>Find CSV</li>
                    <li>
                      It should auto-detect the options, so just hit ENTER
                    </li>
                  </ol>
                </div>
              </div>
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <img
                    src="@/assets/img/template-example-save.jpg"
                    class="img-fluid"
                  />
                </div>
              </div>
              ...
              <div class="card">
                <h3 class="card-header bg-warning text-white">
                  Feature: Using Test Versions
                </h3>
                <div class="card-body">
                  <h6>
                    Test versions allow you to have different versions of your
                    test ("a", "b", "c"...)
                  </h6>
                  <h6>Usage Notes</h6>
                  <ul>
                    ...
                    <li>
                      Not every question needs a version (blank if not needed)
                    </li>
                    <li>
                      ALL versioned questions will be tested (within the
                      selected version)
                    </li>
